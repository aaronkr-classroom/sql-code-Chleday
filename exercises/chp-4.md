...
3. 집합 연산(set operation) 그룹은 합집합, 교집합, 차집합, (카디션 프로덕트) 연산을 포함한다.
...
남학생의 이름과 성별, 학년을 검색합니다.

π(학번, 이름)(σ(과목명='데이터베이스')(수강))
'데이터베이스' 과목을 수강하는 학생들의 학번과 이름을 검색합니다.
π학번,이름(σ 과목명= ′데이터베이스′ (학생⋈수강⋈과목))
